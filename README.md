...
| XGBClassifier + RandomizedSearchCV | subsample=0.93, reg_lambda=0.7000000000000001, reg_alpha=2.55, n_estimators=495, min_child_weight=4, max_depth=16, learning_rate=0.11, gamma=2.22, colsample_bytree0.73 | 0.8323 | 0.8074 | 0.71 | 0.60 | Good AUROC values, mediocre Recall, which can be improved by using loss function related to Recall |
